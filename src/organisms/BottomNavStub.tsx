...
interface BottomNavStubProps {
  onAddClick: () => void;
}

const BottomNavStub: React.FC<BottomNavStubProps> = ({ onAddClick }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-200 flex justify-around items-center z-10">
      ...
      <Link
        to="/projects"
        className={`flex flex-col items-center justify-center w-16 h-16 ${
          isActive('/projects') ? 'text-purple-600' : 'text-gray-500'
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
