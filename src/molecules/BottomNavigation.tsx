...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white p-3 flex justify-between items-center shadow-md z-20">
      <Link
        to="/dashboard"
      ...
      <Link
        to="/calendar"
        className={`flex flex-col items-center ${
          isActive("/calendar") ? "text-purple-600" : "text-gray-500"
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="relative">
        <Link to="/project/new" className="flex flex-col items-center">
          ...
          <span className="text-xs mt-1 text-purple-600">{t("addNew")}</span>
        </Link>
      </div>
      ...
      <Link
        to="/tasks"
        className={`flex flex-col items-center ${
          isActive("/tasks") ? "text-purple-600" : "text-gray-500"
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
